...
if __name__ == '__main__':
  ...
  images_path = './LLaVA-CC3M-Pretrain-595K/sft_images'
  data_train_path = './LLaVA-CC3M-Pretrain-595K/sft_data_train.json'
  data_test_path = './LLaVA-CC3M-Pretrain-595K/sft_data_test.json'
  output_dir = 'save/sft' 
  ...
  trainer = Trainer(
      model=model,
      args=args,
      train_dataset=SFTDataset(images_path, data_train_path, tokenizer, processor, config),
      eval_dataset=SFTDataset(images_path, data_test_path, tokenizer, processor, config),
